    ...
    explicit inputhandler_t(sidebar_t& sidebar, client_model_t& clients,
        ...
        : m_sidebar(sidebar),
          ...
          m_mousebinds({
              ...
              { { SCROLL_DOWN_BUTTON, MODMASK,              NO },  { mouseop_t::focus_bck,           NO } },
              { { SCROLL_UP_BUTTON,   MODMASK,              NO },  { mouseop_t::focus_fwd,           NO } },
              { { SCROLL_DOWN_BUTTON, MODMASK|ShiftMask,    NO },  { mouseop_t::goto_next_ws,        NO } },
              { { SCROLL_UP_BUTTON,   MODMASK|ShiftMask,    NO },  { mouseop_t::goto_prev_ws,        NO } },
              ...
              { { SCROLL_DOWN_BUTTON, MODMASK,             YES },  { mouseop_t::focus_bck,           NO } },
              { { SCROLL_UP_BUTTON,   MODMASK,             YES },  { mouseop_t::focus_fwd,           NO } },
              { { SCROLL_DOWN_BUTTON, MODMASK|ShiftMask,   YES },  { mouseop_t::goto_next_ws,        NO } },
              { { SCROLL_UP_BUTTON,   MODMASK|ShiftMask,   YES },  { mouseop_t::goto_prev_ws,        NO } },
