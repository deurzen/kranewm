    ...
    explicit inputhandler_t(sidebar_t& sidebar, client_model_t& clients,
        ...
        : m_sidebar(sidebar),
          ...
          m_mousebinds({
              ...
              { { RIGHT_BUTTON,       MODMASK|ControlMask, YES },  mouseop_t::toggle_fullscreen },
          }),
          m_keybinds({
              ...
              { { XK_bracketleft,  MODMASK|ControlMask }, keyop_t::dec_m1weight                 },
              { { XK_bracketright, MODMASK|ControlMask }, keyop_t::inc_m1weight                 },
