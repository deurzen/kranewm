    ...
    explicit inputhandler_t(sidebar_t& sidebar, client_model_t& clients,
      ...
      : m_sidebar(sidebar),
        ...
        m_keybinds({
            ...
            { { 0x1008ff14,      0 },                   { "playerctl play-pause" }                                                },
            { { 0x1008ff15,      0 },                   { "playerctl stop" }                                                      },
            { { 0x1008ff16,      0 },                   { "playerctl previous" }                                                  },
            { { 0x1008ff17,      0 },                   { "playerctl next" }                                                      },
            ...
            { { XK_p,            MODMASK|SECMASK },     { "playerctl play-pause" }                                                },
            { { XK_BackSpace,    MODMASK|SECMASK },     { "playerctl stop" }                                                      },
            { { XK_k,            MODMASK|SECMASK },     { "playerctl previous" }                                                  },
            { { XK_j,            MODMASK|SECMASK },     { "playerctl next" }                                                      },
            { { XK_bracketleft,  MODMASK|SECMASK },     { "playerctl position -5" }                                               },
            { { XK_bracketright, MODMASK|SECMASK },     { "playerctl position +5" }                                               },
