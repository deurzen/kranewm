    ...
    explicit inputhandler_t(sidebar_t& sidebar, client_model_t& clients,
      ...
      : m_sidebar(sidebar),
        ...
        m_processbinds({
            ...
            { { XK_space, MODMASK|SECMASK     },      "Spotify" },
        }),
        m_mousebinds({
        ...
        m_keybinds({
            ...
            { { 0x1008ff14,      0 },                   { "playerctl --player playerctld play-pause" }                            },
            { { 0x1008ff15,      0 },                   { "playerctl --player playerctld stop" }                                  },
            { { 0x1008ff16,      0 },                   { "playerctl --player playerctld previous" }                              },
            { { 0x1008ff17,      0 },                   { "playerctl --player playerctld next" }                                  },
            { { 0x1008ff02,      0 },                   { "xbacklight -inc 10" }                                                  },
            { { 0x1008ff03,      0 },                   { "xbacklight -dec 10" }                                                  },
            { { XK_Print,        0 },                   { "maim -m 1 -s $(date +$HOME/screenshots/scrots/SS_%Y-%h-%d_%H-%M-%S.png)" } },
            { { 0x1008ff02,      ShiftMask },           { "xbacklight -inc 5" }                                                   },
            { { 0x1008ff03,      ShiftMask },           { "xbacklight -dec 5" }                                                   },
            { { XK_Print,        ShiftMask },           { "maim -m 1 $(date +$HOME/screenshots/scrots/SS_%Y-%h-%d_%H-%M-%S.png)" }    },
            ...
            { { XK_F10,          MODMASK },             { commandop_t::profilesave, 1 }                                           },
            { { XK_F11,          MODMASK },             { commandop_t::profilesave, 2 }                                           },
            { { XK_F12,          MODMASK },             { commandop_t::profilesave, 3 }                                           },
            { { XK_p,            MODMASK|SECMASK },     { "playerctl --player playerctld play-pause" }                            },
            { { XK_BackSpace,    MODMASK|SECMASK },     { "playerctl --player playerctld stop" }                                  },
            { { XK_k,            MODMASK|SECMASK },     { "playerctl --player playerctld previous" }                              },
            ...
            { { XK_i,            MODMASK|ShiftMask },   { commandop_t::clientinvincible }                                         },
            ...
            { { XK_p,            MODMASK|ShiftMask },   { "~/bin/dmenupass" }                                                     },
            { { XK_q,            MODMASK|ShiftMask },   { "firefox" }                                                             },
            { { XK_F10,          MODMASK|ShiftMask },   { commandop_t::profileload, 1 }                                           },
            { { XK_F11,          MODMASK|ShiftMask },   { commandop_t::profileload, 2 }                                           },
            { { XK_F12,          MODMASK|ShiftMask },   { commandop_t::profileload, 3 }                                           },
            ...
            { { XK_p,            MODMASK|ControlMask }, { "~/bin/dmenupass --copy" }                                              },
            { { XK_o,            MODMASK|ControlMask }, { "~/bin/dmenunotify" }                                                   },
