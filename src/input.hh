    ...
    explicit inputhandler_t(sidebar_t& sidebar, client_model_t& clients,
        ...
        : m_sidebar(sidebar),
          ...
          m_mousebinds({
              ...
              { { SCROLL_UP_BUTTON,   MODMASK,              NO },  { mouseop_t::focus_fwd,          YES } },
              { { SCROLL_DOWN_BUTTON, MODMASK|ShiftMask,    NO },  { mouseop_t::goto_next_ws,       YES } },
              { { SCROLL_UP_BUTTON,   MODMASK|ShiftMask,    NO },  { mouseop_t::goto_prev_ws,       YES } },
              { { SCROLL_DOWN_BUTTON, MODMASK|ControlMask,  NO },  { mouseop_t::goto_next_cx,       YES } },
              { { SCROLL_UP_BUTTON,   MODMASK|ControlMask,  NO },  { mouseop_t::goto_prev_cx,       YES } },
              { { LEFT_BUTTON,        MODMASK,             YES },  { mouseop_t::client_move,         NO } },
              { { RIGHT_BUTTON,       MODMASK,             YES },  { mouseop_t::client_resize,       NO } },
              { { MIDDLE_BUTTON,      MODMASK,             YES },  { mouseop_t::center_client,       NO } },
              { { BACKWARD_BUTTON,    MODMASK,             YES },  { mouseop_t::client_next_ws,      NO } },
              { { FORWARD_BUTTON,     MODMASK,             YES },  { mouseop_t::client_prev_ws,      NO } },
              { { SCROLL_DOWN_BUTTON, MODMASK,             YES },  { mouseop_t::focus_bck,          YES } },
              { { SCROLL_UP_BUTTON,   MODMASK,             YES },  { mouseop_t::focus_fwd,          YES } },
              { { SCROLL_DOWN_BUTTON, MODMASK|ShiftMask,   YES },  { mouseop_t::goto_next_ws,       YES } },
              { { SCROLL_UP_BUTTON,   MODMASK|ShiftMask,   YES },  { mouseop_t::goto_prev_ws,       YES } },
              { { MIDDLE_BUTTON,      MODMASK|ShiftMask,   YES },  { mouseop_t::toggle_float,        NO } },
              { { RIGHT_BUTTON,       MODMASK|ShiftMask,   YES },  { mouseop_t::toggle_fullscreen,   NO } },
              { { SCROLL_DOWN_BUTTON, MODMASK|ControlMask, YES },  { mouseop_t::goto_next_cx,       YES } },
              { { SCROLL_UP_BUTTON,   MODMASK|ControlMask, YES },  { mouseop_t::goto_prev_cx,       YES } },
              { { RIGHT_BUTTON,       MODMASK|ControlMask, YES },  { mouseop_t::toggle_disown,       NO } },
          }),
          m_keybinds({
