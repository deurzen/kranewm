    ...
    explicit inputhandler_t(sidebar_t& sidebar, client_model_t& clients,
        ...
        : m_sidebar(sidebar),
          ...
          m_keybinds({
              ...
              { { XK_e,            MODMASK },             { "/usr/bin/st -e zsh -i -c vifmrun" }                  },
              ...
              { { XK_Up,           MODMASK|ControlMask }, { commandop_t::clientsnapnorth }                        },
              { { XK_Right,        MODMASK|ControlMask }, { commandop_t::clientsnapeast }                         },
              ...
              /* { { XK_h,            MODMASK|ShiftMask|ControlMask }, { commandop_t::clientgrow, }    }, */
