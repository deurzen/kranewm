...
{
    windowstack_window_t(x_wrapper::window_t _win, layer_t _layer, bool _floating)
        : win(_win), layer(_layer), floating(_floating) {}
...
public:
    ...
    void raise_window(x_wrapper::window_t, bool);
    void lower_window(x_wrapper::window_t, bool);

    void apply();

private:
    ::std::unordered_map<x_wrapper::window_t, layer_t> m_win_layers;
    ::std::unordered_map<x_wrapper::window_t, bool> m_win_floating;
