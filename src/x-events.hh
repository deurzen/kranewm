    ...
    explicit x_events_t(ewmh_t& ewmh, client_model_t& clients, x_model_t& x)
        : m_ewmh(ewmh),
          ...
          m_keybinds({
              ...
              { { XK_1,            MODMASK },             keyop_t::activate_workspace_1         },
              { { XK_2,            MODMASK },             keyop_t::activate_workspace_2         },
              { { XK_3,            MODMASK },             keyop_t::activate_workspace_3         },
              { { XK_4,            MODMASK },             keyop_t::activate_workspace_4         },
              { { XK_5,            MODMASK },             keyop_t::activate_workspace_5         },
              { { XK_6,            MODMASK },             keyop_t::activate_workspace_6         },
              { { XK_7,            MODMASK },             keyop_t::activate_workspace_7         },
              { { XK_8,            MODMASK },             keyop_t::activate_workspace_8         },
              { { XK_bracketleft,  MODMASK },             keyop_t::activate_prev_ws             },
              { { XK_bracketright, MODMASK },             keyop_t::activate_next_ws             },
              { { XK_grave,        MODMASK },             keyop_t::toggle_scratchpad_1          },
              { { XK_backslash,    MODMASK },             keyop_t::toggle_scratchpad_2          },
              { { XK_9,            MODMASK },             keyop_t::activate_workspace_9         },
              ...
              { { XK_h,            MODMASK },             keyop_t::dec_mratio                   },
              { { XK_i,            MODMASK },             keyop_t::inc_nmaster                  },
              { { XK_l,            MODMASK },             keyop_t::inc_mratio                   },
              ...
              { { XK_semicolon,    MODMASK },             keyop_t::toggle_scratchpad_1          },
              ...
              { { XK_1,            MODMASK|SECMASK },     keyop_t::jump_client_1                },
              { { XK_2,            MODMASK|SECMASK },     keyop_t::jump_client_2                },
              { { XK_3,            MODMASK|SECMASK },     keyop_t::jump_client_3                },
              { { XK_4,            MODMASK|SECMASK },     keyop_t::jump_client_4                },
              { { XK_5,            MODMASK|SECMASK },     keyop_t::jump_client_5                },
              { { XK_6,            MODMASK|SECMASK },     keyop_t::jump_client_6                },
              { { XK_7,            MODMASK|SECMASK },     keyop_t::jump_client_7                },
              { { XK_8,            MODMASK|SECMASK },     keyop_t::jump_client_8                },
              { { XK_9,            MODMASK|SECMASK },     keyop_t::jump_client_9                },
              { { XK_Return,       MODMASK|ShiftMask },   keyop_t::spawn_quickterm              },
              { { XK_m,            MODMASK|ShiftMask },   keyop_t::mark_client                  },
              { { XK_1,            MODMASK|ShiftMask },   keyop_t::client_to_workspace_1        },
              { { XK_2,            MODMASK|ShiftMask },   keyop_t::client_to_workspace_2        },
              { { XK_3,            MODMASK|ShiftMask },   keyop_t::client_to_workspace_3        },
              { { XK_4,            MODMASK|ShiftMask },   keyop_t::client_to_workspace_4        },
              { { XK_5,            MODMASK|ShiftMask },   keyop_t::client_to_workspace_5        },
              { { XK_6,            MODMASK|ShiftMask },   keyop_t::client_to_workspace_6        },
              { { XK_7,            MODMASK|ShiftMask },   keyop_t::client_to_workspace_7        },
              { { XK_8,            MODMASK|ShiftMask },   keyop_t::client_to_workspace_8        },
              { { XK_9,            MODMASK|ShiftMask },   keyop_t::client_to_workspace_9        },
              { { XK_grave,        MODMASK|ShiftMask },   keyop_t::client_to_scratchpad_1       },
              { { XK_backslash,    MODMASK|ShiftMask },   keyop_t::client_to_scratchpad_2       },
              { { XK_bracketleft,  MODMASK|ShiftMask },   keyop_t::client_to_prev_workspace     },
              { { XK_bracketright, MODMASK|ShiftMask },   keyop_t::client_to_next_workspace     },
              ...
              { { XK_bracketleft,  MODMASK|ControlMask }, keyop_t::dec_mfactor                  },
              { { XK_bracketright, MODMASK|ControlMask }, keyop_t::inc_mfactor                  },
              ...
              { { XK_1,            MODMASK|ControlMask }, keyop_t::deiconify_1                  },
              { { XK_2,            MODMASK|ControlMask }, keyop_t::deiconify_2                  },
              { { XK_3,            MODMASK|ControlMask }, keyop_t::deiconify_3                  },
              { { XK_4,            MODMASK|ControlMask }, keyop_t::deiconify_4                  },
              { { XK_5,            MODMASK|ControlMask }, keyop_t::deiconify_5                  },
              { { XK_6,            MODMASK|ControlMask }, keyop_t::deiconify_6                  },
              { { XK_7,            MODMASK|ControlMask }, keyop_t::deiconify_7                  },
              { { XK_8,            MODMASK|ControlMask }, keyop_t::deiconify_8                  },
              { { XK_9,            MODMASK|ControlMask }, keyop_t::deiconify_9                  },
