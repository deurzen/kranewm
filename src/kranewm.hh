...
public:
    kranewm_t()
      : m_running(true),
        ...
        m_input(m_sidebar, m_clients, m_windowstack, m_processes, &m_running),
        m_ipc(m_input),
        m_events(m_ewmh, m_sidebar, m_windowstack, m_processes, m_clients, m_x, m_input, m_ipc, &m_running),
